module Shared.RandomColor exposing (..)
...
getColor : Int -> String
getColor n =
    case (Dict.get n colorSwatches) of
        Just s -> s
        Nothing -> ""
...
randomColor: Cmd Msg
randomColor =
    Random.generate RandColor (Random.int 1 (Dict.size colorSwatches))

colorSwatches: Dict Int String
colorSwatches = 
    List.indexedMap (,) colorList
        |> Dict.fromList 
